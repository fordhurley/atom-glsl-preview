...
module.exports = {
  schema: {
    ...
    defaultSize: {
      type: "number",
      default: 0,
      description: "Default size for the preview (width and height). Leave blank to fill the split pane.",
    },
    grammars: {
      type: "array",
      default: [
    ...
    includeDefaultUniforms: {
      type: "boolean",
      default: true,
      description: "Include default uniforms as part of the shader so they don't have to be declared manually.",
    },
  },
