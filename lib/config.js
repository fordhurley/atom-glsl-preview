...
module.exports = {
  ...
  upgrade() {
    ...
    const oldKey = "openPreviewInSplitPane";
    const newKey = "openInSplitPane";
    if (Object.prototype.hasOwnProperty.call(configs, oldKey)) {
      atom.config.unset(`${packageKey}.${oldKey}`);
      atom.config.set(`${packageKey}.${newKey}`, configs[oldKey]);
      return true;
    }
    return false;
  },
