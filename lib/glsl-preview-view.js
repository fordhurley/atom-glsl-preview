...
module.exports = class GlslPreviewView {
  constructor({editorId}) {
    ...
    this.shader.onShaderError = this.showErrors.bind(this);
  ...
  updateShader(source) {
    ...
    this.shader.setShader(compiledSource, Config.includeDefaultUniforms());
  }
  ...
  showErrors(messages) {
    ...
    this.markers = messages.map((message) => {
