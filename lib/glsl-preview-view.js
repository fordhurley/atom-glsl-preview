...
module.exports = class GlslPreviewView {
  constructor({editorId}) {
    ...
    this.userSize = {};
    interact(this.renderer.domElement).resizable({
  ...
  _onMouseMove() {
    const [width, height] = elementSize(this.renderer.domElement);
  ...
  subscribeToEvents() {
    ...
    this.disposables.add(Config.onDidChangeMaxSize(debounce(this._onResize, 250)));
